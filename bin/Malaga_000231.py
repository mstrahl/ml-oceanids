...
fname = 'training_data_oceanids_Malaga-sf_2000-2023.csv' # training input data file
mdl_name='mdl_'+pred+'_2000-2023_sf_Malaga.txt'
fscorepic='Fscore_'+pred+'-sf-Malaga.png'
xgbstudy='xgb-'+pred+'-Malaga'
obsfile='obs-oceanids-'+start+'-'+end+'-'+pred+'-'+harbor+'-daymax.csv'
test_y=[2005, 2008, 2010, 2012, 2023]
train_y= [2000, 2001, 2002, 2003, 2004, 2006, 2007, 2009, 2011, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]
