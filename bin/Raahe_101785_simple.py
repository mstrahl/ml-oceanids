bbox='24.15695,64.91589,24.65695,64.41589'
harbor='Raahe'
FMISID='101785'
lat=64.66589
lon=24.40695
...
mdl_name='mdl_'+pred+'_2013-2023_sf_Raahe_simple.txt'
fscorepic='Fscore_'+pred+'-sf-Raahe-simple.png'
xgbstudy='xgb-'+pred+'-Raahe'
obsfile='obs-oceanids-'+start+'-'+end+'-all-'+harbor+'-daymean-daymax.csv'

test_y=[2017,2023]
train_y=[2013,2014,2015,2016,2018,2019,2020,2021,2022]
...
#droplist=['utctime','utctime.1','WS_PT1H_AVG','latitude', 'longitude', 'FMISID', pred,'lat-1', 'lon-1', 'lat-2', 'lon-2', 'lat-3', 'lon-3', 'lat-4', 'lon-4','hour','tlwc-1','tlwc-2','tlwc-3','tlwc-4']#,'dayOfYear','e-1','e-2','e-3','e-4','msl-1','msl-2','msl-3','msl-4','str-1','str-2','str-3','str-4','tcc-1','tcc-2','tcc-3','tcc-4','lsm-1','lsm-2','lsm-3','lsm-4']
