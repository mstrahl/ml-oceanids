...
fname = 'training_data_oceanids_cnrm-knmi-Vuosaari-cordex.csv' # training input data file
obsfile='obs-oceanids-'+start+'-'+end+'-all-'+harbor+'-cnrm-knmi-daymean-daymax.csv'
fscorepic='Fscore_'+pred+'-cnrm-knmi-'+harbor+'.png'
mdl_name='mdl_WGPT24MAX_2013-2023_cnrm-knmi.txt'
xgbstudy='xgb-'+pred+'-Vuosaari-cnrm-knmi'
