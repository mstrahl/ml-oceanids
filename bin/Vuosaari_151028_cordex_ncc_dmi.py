...
fname = 'training_data_oceanids_ncc-dmi-Vuosaari-cordex.csv' # training input data file
obsfile='obs-oceanids-'+start+'-'+end+'-all-'+harbor+'-ncc-dmi-daymean-daymax.csv'
fscorepic='Fscore_'+pred+'-ncc-dmi-'+harbor+'.png'
mdl_name='mdl_WGPT24MAX_2013-2023_ncc-dmi.txt'
xgbstudy='xgb-'+pred+'-Vuosaari-ncc-dmi'
